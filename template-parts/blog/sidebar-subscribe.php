<?php
/**
 * The sidebar subscribe for posts
 *
...
<aside id="sidebar-subscribe" class="blog-sidebar blog-subscribe-sidebar">
	<h3><?php esc_html_e( 'For weekly recipes, articles, performance tips and giveaways', 'tnn' ); ?></h3>
